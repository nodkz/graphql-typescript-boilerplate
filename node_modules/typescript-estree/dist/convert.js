...
function convert(config) {
    ...
    function convertBodyExpressions(nodes) {
        ...
        const unique = [];
        const allowDirectives = node_utils_1.default.canContainDirective(node);
        return (nodes
            .map(statement => {
    ...
    function fixTypeAnnotationParentLocation(typeAnnotationParent) {
        ...
        typeAnnotationParent.loc = node_utils_1.default.getLocFor(typeAnnotationParent.range[0], typeAnnotationParent.range[1], ast);
    }
    /**
    ...
    switch (node.kind) {
        ...
        case SyntaxKind.FunctionDeclaration: {
            const isDeclare = node_utils_1.default.hasModifier(SyntaxKind.DeclareKeyword, node);
        ...
        case SyntaxKind.VariableStatement:
            ...
            if (node_utils_1.default.hasModifier(SyntaxKind.DeclareKeyword, node)) {
                result.declare = true;
            }
            // check for exports
            result = node_utils_1.default.fixExports(node, result, ast);
        ...
        case SyntaxKind.Constructor: {
            const constructorIsStatic = node_utils_1.default.hasModifier(SyntaxKind.StaticKeyword, node), constructorIsAbstract = node_utils_1.default.hasModifier(SyntaxKind.AbstractKeyword, node), firstConstructorToken = constructorIsStatic
            ...
            const constructorIdentifierLocStart = ast.getLineAndCharacterOfPosition(firstConstructorToken.getStart(ast)), constructorIdentifierLocEnd = ast.getLineAndCharacterOfPosition(firstConstructorToken.getEnd(ast)), constructorIsComputed = !!node.name && node_utils_1.default.isComputedProperty(node.name);
            let constructorKey;
        ...
        case SyntaxKind.ClassExpression: {
            ...
            if (implementsClause) {
                result.implements = implementsClause.types.map(el => convertHeritageClause(ast_node_types_1.AST_NODE_TYPES.TSClassImplements, el));
            }
            if (node_utils_1.default.hasModifier(SyntaxKind.DeclareKeyword, node)) {
                result.declare = true;
            }
        ...
        case SyntaxKind.BinaryExpression:
            ...
            if (node_utils_1.default.isComma(node.operatorToken)) {
                ...
                const type = node_utils_1.default.getBinaryExpressionType(node.operatorToken);
                Object.assign(result, {
                    type,
                    operator: node_utils_1.default.getTextForTokenKind(node.operatorToken.kind),
                    left: converter(node.left, config.inTypeMode, type === ast_node_types_1.AST_NODE_TYPES.AssignmentExpression),
        ...
        case SyntaxKind.UndefinedKeyword: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES[`TS${SyntaxKind[node.kind]}`]
            });
            break;
        }
        case SyntaxKind.NonNullExpression: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSNonNullExpression,
                expression: convertChild(node.expression)
            });
            break;
        }
        case SyntaxKind.TypeLiteral: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSTypeLiteral,
        ...
        case SyntaxKind.ArrayType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSArrayType,
        ...
        case SyntaxKind.IndexedAccessType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSIndexedAccessType,
        ...
        case SyntaxKind.ConditionalType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSConditionalType,
        ...
        case SyntaxKind.TypeQuery: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSTypeQuery,
        ...
        case SyntaxKind.MappedType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSMappedType,
            ...
            if (node.readonlyToken) {
                if (node.readonlyToken.kind === SyntaxKind.ReadonlyKeyword) {
                    ...
                    result.readonly = node_utils_1.default.getTextForTokenKind(node.readonlyToken.kind);
                }
            }
            if (node.questionToken) {
                if (node.questionToken.kind === SyntaxKind.QuestionToken) {
                    ...
                    result.optional = node_utils_1.default.getTextForTokenKind(node.questionToken.kind);
                }
            }
            if (node.type) {
        ...
        case SyntaxKind.TypeAliasDeclaration: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSTypeAliasDeclaration,
                id: convertChild(node.name),
        ...
        case SyntaxKind.MethodSignature: {
            ...
            if (node_utils_1.default.isOptional(node)) {
                result.optional = true;
            }
            if (node.type) {
                result.returnType = convertTypeAnnotation(node.type);
            }
            if (node_utils_1.default.hasModifier(SyntaxKind.ReadonlyKeyword, node)) {
                result.readonly = true;
            }
            ...
            if (node_utils_1.default.hasModifier(SyntaxKind.ExportKeyword, node)) {
                result.export = true;
            }
            if (node_utils_1.default.hasModifier(SyntaxKind.StaticKeyword, node)) {
                result.static = true;
            }
            break;
        }
        ...
        case SyntaxKind.CallSignature: {
            ...
            switch (node.kind) {
                case SyntaxKind.ConstructSignature:
                    type = ast_node_types_1.AST_NODE_TYPES.TSConstructSignatureDeclaration;
                    break;
                case SyntaxKind.CallSignature:
                    type = ast_node_types_1.AST_NODE_TYPES.TSCallSignatureDeclaration;
                    break;
                case SyntaxKind.FunctionType:
                    type = ast_node_types_1.AST_NODE_TYPES.TSFunctionType;
                    break;
                case SyntaxKind.ConstructorType:
                default:
                    type = ast_node_types_1.AST_NODE_TYPES.TSConstructorType;
                    break;
            }
            Object.assign(result, {
                type: type,
                ...
                for (const heritageClause of interfaceHeritageClauses) {
                    if (heritageClause.token === SyntaxKind.ExtendsKeyword) {
                        for (const n of heritageClause.types) {
                            interfaceExtends.push(convertHeritageClause(ast_node_types_1.AST_NODE_TYPES.TSInterfaceHeritage, n));
                        }
                    }
                    else if (heritageClause.token === SyntaxKind.ImplementsKeyword) {
                        for (const n of heritageClause.types) {
                            interfaceImplements.push(convertHeritageClause(ast_node_types_1.AST_NODE_TYPES.TSInterfaceHeritage, n));
                        }
                    }
                }
        ...
        case SyntaxKind.OptionalType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSOptionalType,
                typeAnnotation: convertChildType(node.type)
            });
            break;
        }
        case SyntaxKind.ParenthesizedType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSParenthesizedType,
                typeAnnotation: convertChildType(node.type)
            });
            break;
        }
        case SyntaxKind.TupleType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSTupleType,
        ...
        case SyntaxKind.UnionType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSUnionType,
        ...
        case SyntaxKind.IntersectionType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSIntersectionType,
                types: node.types.map(convertChildType)
            });
            break;
        }
        case SyntaxKind.RestType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSRestType,
                typeAnnotation: convertChildType(node.type)
            });
            break;
        }
        case SyntaxKind.AsExpression: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSAsExpression,
                expression: convertChild(node.expression),
                typeAnnotation: convertChildType(node.type)
            });
            break;
        ...
        case SyntaxKind.InferType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSInferType,
                typeParameter: convertChildType(node.typeParameter)
            });
            break;
        }
        case SyntaxKind.LiteralType: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSLiteralType,
        ...
        case SyntaxKind.TypeAssertionExpression: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSTypeAssertion,
                typeAnnotation: convertChildType(node.type),
                expression: convertChild(node.expression)
            });
            break;
        ...
        case SyntaxKind.ImportEqualsDeclaration: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSImportEqualsDeclaration,
                id: convertChild(node.name),
                moduleReference: convertChild(node.moduleReference),
                isExport: node_utils_1.default.hasModifier(SyntaxKind.ExportKeyword, node)
            });
            break;
        }
        case SyntaxKind.ExternalModuleReference: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSExternalModuleReference,
                expression: convertChild(node.expression)
            });
            break;
        }
        case SyntaxKind.NamespaceExportDeclaration: {
            Object.assign(result, {
                type: ast_node_types_1.AST_NODE_TYPES.TSNamespaceExportDeclaration,
                id: convertChild(node.name)
            });
            break;
        }
