...
const providers_1 = require("../schema/providers");
...
class GraphQLProject {
    constructor({ config, fileSet, loadingHandler, clientIdentity }) {
        ...
        this.schemaProvider = providers_1.schemaProviderFromConfig(config);
        const { engine } = config;
        if (engine.apiKey) {
    ...
    includesFile(uri) {
        return this.fileSet.includesFile(vscode_uri_1.default.parse(uri).fsPath);
    }
