...
export declare const projectsFromConfig: (config: ApolloConfigFormat, configURI?: URI | undefined) => (ClientConfig | ServiceConfig)[];
...
export declare class ApolloConfig {
    ...
    readonly configDirURI: URI | undefined;
...
export declare const loadConfig: ({ configPath, name, type }: LoadConfigSettings) => Promise<ApolloConfig>;
